                            ...
                            <table class="table app-table-hover mb-0 text-left">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" valign="middle">Judul Inggris</th> <!-- Field baru untuk Judul Inggris -->
                                        ...
                                        <th class="text-center" valign="middle">Description Inggris</th> <!-- Field baru untuk Description Inggris -->
                                ...
                                <tbody>
                                    <?php foreach ($artikels as $artikel) : ?>
                                        <tr>
                                            ...
                                            <td><?= $artikel->judul_inggris ?></td> <!-- Tampilkan Judul Inggris -->
                                            <td><?= $artikel->meta_title ?></td>
                                            <td><?= $artikel->meta_title_inggris ?></td>
                                            <td><?= $artikel->meta_description ?></td>
                                            <td><?= $artikel->meta_description_inggris ?></td>
                                            <td><?= $artikel->deskripsi_artikel ?></td>
                                            <td><?= $artikel->description_inggris ?></td> <!-- Tampilkan Description Inggris -->
