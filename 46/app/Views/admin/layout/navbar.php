<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="<?= base_url('admin/dashboard') ?>"><img class="logo-icon me-2" src="<?= base_url('assets/images/Logo_Petal-Paradise_21072024090350.png') ?>" alt="logo"><span class="logo-text">Petal Paradise</span></a>
        </div><!--//app-branding-->
