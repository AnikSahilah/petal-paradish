                                ...
                                <tbody>
                                    <?php foreach ($all_data_aktivitas as $tampilAktivitas) : ?>
                                        <tr>
                                            ...
                                            <td><?= $tampilAktivitas->meta_title ?></td>
                                            <td><?= $tampilAktivitas->meta_description ?></td>
                                            <td><?= $tampilAktivitas->meta_title_inggris ?></td>
                                            <td><?= $tampilAktivitas->meta_description_inggris ?></td>
