                    ...
                    <form action="<?= base_url('admin/aktivitas/proses_edit/' . $aktivitasData->id_aktivitas) ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea type="text" class="form-control" id="meta_title" name="meta_title"><?= $aktivitasData->meta_title; ?></textarea>

                                <label class="form-label">Meta Title (EN)</label>
                                <textarea type="text" class="form-control" id="meta_title_inggris" name="meta_title_inggris"><?= $aktivitasData->meta_title_inggris; ?></textarea>

                                <label class="form-label">Meta Description (IN)</label>
                                <textarea type="text" class="form-control" id="meta_description" name="meta_description"><?= $aktivitasData->meta_description; ?></textarea>

                                <label class="form-label">Meta Description (EN)</label>
                                <textarea type="text" class="form-control" id="meta_description_inggris" name="meta_description_inggris"><?= $aktivitasData->meta_description_inggris; ?></textarea>
                                <div class="mb-3">
