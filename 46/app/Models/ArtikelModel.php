...
class ArtikelModel extends Model
{
    ...
    protected $allowedFields = ['id_artikel', 'judul_artikel', 'foto_artikel', 'deskripsi_artikel', 'meta_title', 'meta_description', 'meta_title_inggris', 'meta_description_inggris', 'judul_inggris', 'description_inggris', 'slug_id', 'slug_en'];
